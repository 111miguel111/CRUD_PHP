...
<body>
    ...
    if ($result->num_rows > 0) {
        ...
        echo "<tr><th>NIF</th><th>Nombre</th><th>Apellido 1</th><th>Apellido 2</th><th>Email</th><th>Dirección</th><th>Código Postal</th><th>Municipio</th><th>Provincia</th><th>Beca</th></tr>";
        while ($row = $result->fetch_assoc()) {
            ...
            echo "<td>" . ($row['beca'] == 1 ? 'Sí' : 'No') . "</td>";
            echo "</tr>";
        }
        echo "</table>";
    } else {
        echo "No se encontró ningún alumno con el NIF $nif";
    }
